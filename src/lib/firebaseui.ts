...
;(function () {
   ;(function () {
      ...
      function Cb(a, b, c) {
         return q(a)
            ? ((a = encodeURI(a).replace(b, Kb)), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a)
            : null
      }
      function Kb(a) {
         a = a.charCodeAt(0)
         ...
         return Zb(a, function () {
            for (
               ...
               do {
                  ...
                  b =
                     bb(0 == g[1].length ? 0 : parseInt(g[1], 10), 0 == h[1].length ? 0 : parseInt(h[1], 10)) ||
      ...
      function Dd(a) {
         null != a && a.fa === ed
            ...
            : ((a = String(a)), Ed.test(a) || (Fa("Bad value `%s` for |filterCssValue", [a]), (a = "zSoyz")))
         return a
      }
      var Fd = {
         "\x00": "&#0;",
      ...
      function se(a, b, c, d, e) {
         if (qa(b)) for (var f = 0; f < b.length; f++) se(a, b[f], c, d, e)
            ...
            ((d = ta(d) ? !!d.capture : !!d), (c = me(c)), a && a[ae])
               ...
               : a &&
                 (a = oe(a)) &&
                 ((b = a.a[b.toString()]), (a = -1), b && (a = fe(b, c, d, e)), (c = -1 < a ? b[a] : null) && te(c))
      }
      function te(a) {
      ...
      function Se() {
         if (n.Promise && n.Promise.resolve) {
            ...
            Re = function () {
               var b = Ue
               !sa(n.setImmediate) ||
               (n.Window && n.Window.prototype && !y("Edge") && n.Window.prototype.setImmediate == n.setImmediate)
                  ? (Oe || (Oe = Pe()), Oe(b))
                  : n.setImmediate(b)
            }
      }
            ...
            if (a.h) {
               ...
               if (c.g) {
                  ...
                  e &&
                     (c.a == We && 1 == d
                        ? gf(c, b)
                        : (f ? ((d = f), d.next == c.j && (c.j = d), (d.next = d.next.next)) : hf(c), jf(c, e, $e, b)))
               }
               a.h = null
            } else Xe(a, $e, b)
      }
               ...
               if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf()
                  ...
                  for (d in b)
                     Object.prototype.hasOwnProperty.call(b, d) &&
                        ((f = b[d]),
                        "function" != typeof f && (c.push(e), dh(d, c), c.push(":"), bh(a, f, c), (e = ",")))
                  c.push("}")
                  return
               }
            }
      ...
      function Ci(a) {
         return (a = gi(a, firebase.auth.EmailAuthProvider.PROVIDER_ID)) && "undefined" !== typeof a.requireDisplayName
               ...
               if (
                  ...
                  for (var g = [], h = 0; h < f.length; ) {
                     ...
                     "." == k
                        ? d && h == f.length && g.push("")
                        : ".." == k
                        ? ((1 < g.length || (1 == g.length && "" != g[0])) && g.pop(), d && h == f.length && g.push(""))
                        : (g.push(k), (d = !0))
                  }
                  f = g.join("/")
               }
      ...
      function Vi(a, b) {
         a.classList
            ...
            : Ti(a, b) &&
              (a.className = Ja(Si(a), function (c) {
                 return c != b
              }).join(" "))
      }
      function Wi(a) {
      ...
      l.Jb = function (a) {
         ...
         vj && !$i(a.keyCode, this.R, a.shiftKey, a.ctrlKey, a.altKey, a.metaKey)
            ? this.handleEvent(a)
            : ((this.X = aj(a.keyCode)), wj && (this.Ua = a.altKey))
      }
      l.Kb = function (a) {
         this.X = this.R = -1
         this.Ua = a.altKey
      ...
      l.handleEvent = function (a) {
         ...
         if (z && "keypress" == a.type) {
            ...
            (ec || bc) && "keypress" == a.type
               ? ((d = this.X), (e = 0 <= b.charCode && 63232 > b.charCode && Zi(d) ? b.charCode : 0))
               : ac && !ec
               ? ((d = this.X), (e = Zi(d) ? b.keyCode : 0))
               : ("keypress" == a.type
                    ? (wj && (c = this.Ua),
         ...
         d
            ? 63232 <= d && d in tj
               ? (f = tj[d])
               : 25 == d && a.shiftKey && (f = 9)
            : b.keyIdentifier && b.keyIdentifier in uj && (f = uj[b.keyIdentifier])
         ;(dc && vj && "keypress" == a.type && !$i(f, this.R, a.shiftKey, a.ctrlKey, c, a.metaKey)) ||
            ((a = f == this.R), (this.R = f), (b = new xj(f, e, a, b)), (b.altKey = c), xe(this, b))
      }
      l.N = function () {
         return this.qa
      }
      ...
      function Bj(a, b) {
         ...
         ;(ka(e) && !h) || !a.getBoundingClientRect
            ? (a = new Pc(e, f))
            : ((a = Aj(a)), (a = new Pc(a.right - a.left, a.bottom - a.top)))
      ...
      function N(a, b) {
         ...
         b
            ? (Vi(a, "firebaseui-input-invalid"), Ui(a, "firebaseui-input"), c && Vi(c, "firebaseui-textfield-invalid"))
            : (Vi(a, "firebaseui-input"), Ui(a, "firebaseui-input-invalid"), c && Ui(c, "firebaseui-textfield-invalid"))
      }
      function Jj(a, b, c) {
         b = new oj(b)
         Sd(a, za(Td, b))
      ...
      function Ck(a, b, c) {
         return B('<div class="firebaseui-container firebaseui-id-page-spinner">' + fk({ tb: !0 }, null, c) + "</div>")
      }
      ...
      function Fk(a, b, c) {
         a =
            ...
            B('<a class="firebaseui-link firebaseui-id-resend-email-link" href="javascript:void(0)">Resend</a>') +
            '</div><div class="firebaseui-form-actions">' +
            Yj({ label: D("Back") }) +
            '</div></div><div class="firebaseui-card-footer">' +
            Zj(c) +
         ...
         d =
            ...
            (A(d) +
               ("</strong>. You can connect your <strong>" +
                  (A(a) +
                     ("</strong> account with <strong>" + (A(d) + "</strong> by signing in with email link below.")))))
         a =
            "For this flow to successfully connect your " +
            (A(a) + " account with this email, you have to open the link on the same device or browser.")
         b +=
      ...
      function Nk(a, b, c) {
         ...
         d
            ? ((d = "<strong>" + (A(d) + "</strong> is not authorized to view the requested page.")), (e += d))
            : (e += "User is not authorized to view the requested page.")
         e += "</p>"
         b &&
            ((b = "Please contact <strong>" + (A(b) + "</strong> for authorization.")),
            (e += '<p class="firebaseui-text firebaseui-id-unauthorized-user-admin-email">' + b + "</p>"))
      ...
      function Sk(a) {
         ...
         c +=
            ...
            (b ? '<div class="firebaseui-form-actions">' + Uj() + "</div>" : "") +
            "</div></form></div>"
         return B(c)
      }
         ...
         for (var e = 0; e < b; e++) {
            ...
            "password" == h.providerId
               ...
               ? ((k += '<span class="firebaseui-idp-text firebaseui-idp-text-long">'),
                 ...
                 (k += "</span>"))
               : ((k += '<span class="firebaseui-idp-text firebaseui-idp-text-long">'),
                 h.V ? (k += A(h.V)) : ((p = "Sign in with " + A(gk(f, g))), (k += p)),
                 (k +=
      ...
      function wl() {
         ...
         c
            ? rl.test(c)
               ? (N(a, !0), Nj(b), (b = !0))
               : (N(a, !1), Oj(b, C("That email address isn't correct").toString()), (b = !1))
            : (N(a, !1), Oj(b, C("Enter your email address to continue").toString()), (b = !1))
         return b ? Ua(Wi(a)) : null
      }
      function xl(a, b, c, d, e, f, g) {
         P.call(this, xk, { email: c, ia: !!f }, g, "passwordSignIn", {
            F: d,
            D: e,
         })
         this.w = a
                     ...
                     if (!h || "auth/credential-already-in-use" != h.code)
                        if (h && "auth/email-already-in-use" == h.code && h.email && h.credential) {
                           ...
                           h && "auth/admin-restricted-operation" == h.code && pi(W(a))
                              ? ((h = Q(b)),
                                b.m(),
                                L("handleUnauthorizedUser", a, h, null, firebase.auth.GoogleAuthProvider.PROVIDER_ID))
                              : ((h = T(h)), b.a(h))
               }
            )
            V(a, f)
               ...
               function (e) {
                  if (
                     ...
                     (e && "auth/credential-already-in-use" == e.code) ||
                        (e && "auth/operation-not-supported-in-this-environment" == e.code && Xl(a)
                           ? gm(a, d, { user: null, credential: null })
      ...
      function rm() {
         ...
         var a = qm.call(this),
            b = pm.call(this)
         this.Ra
            ? ((b.type = "text"), Ui(a, "firebaseui-input-toggle-off"), Vi(a, "firebaseui-input-toggle-on"))
            : ((b.type = "password"), Ui(a, "firebaseui-input-toggle-on"), Vi(a, "firebaseui-input-toggle-off"))
         b.focus()
      }
      function sm() {
      ...
      function ym(a, b, c, d) {
         "auth/weak-password" == (d && d.code)
            ? ((a = T(d)), N(c.i(), !1), Oj(c.w(), a), c.i().focus())
            : (c && c.m(), (c = new Gl()), c.render(b), Y(a, c))
      }
      function zm(a, b, c) {
      ...
      function Cm(a, b, c, d, e, f) {
         P.call(this, Gk, { email: c }, f, "emailLinkSignInConfirmation", {
            F: d,
            D: e,
         })
         this.l = a
      ...
      function Dm(a, b, c, d, e) {
         P.call(this, Lk, { ga: a }, e, "emailLinkSignInLinkingDifferentDevice", {
            F: c,
            D: d,
         })
         this.i = b
            ...
            f.I(
               ...
               function (ya) {
                  Wk
                     ...
                     : (f.m(), L("emailLinkConfirmation", a, b, c, Jm))
               },
               function (ya) {
                  var md = void 0
      ...
      function Im(a, b, c, d, e, f) {
         ...
         var h = null
         e = (f ? Lm(a, f, c, d, e) : Mm(a, c, d, e)).then(
            function (k) {
               wh(uh, X(a))
               wh(th, X(a))
               b.h()
            ...
            function (k) {
               ...
               if (!k.name || "cancel" != k.name) {
                  ...
                  "auth/email-already-in-use" == k.code || "auth/credential-already-in-use" == k.code
                     ...
                     ? ((p = C("The email provided does not match the current sign-in session.").toString()),
                       L("emailLinkConfirmation", a, g, d, Jm, null, p))
                     : S(a, g, c, p)
               }
            }
         )
      ...
      function Nm(a, b, c, d, e, f) {
         P.call(this, Kk, { email: a, ga: b }, f, "emailLinkSignInLinking", {
            F: d,
            D: e,
         })
         this.i = c
      ...
      function Sm(a, b, c, d, e, f) {
         P.call(this, Mk, { email: a, ga: b }, f, "federatedLinking", {
            F: d,
            D: e,
         })
         this.i = c
      ...
      function Um(a, b, c, d, e, f) {
         P.call(this, zk, { email: c, Ta: !!b }, f, "passwordRecovery", {
            F: d,
            D: e,
         })
         this.l = a
                           ...
                           switch (k.code) {
                              ...
                              case "auth/admin-restricted-operation":
                                 pi(W(a))
                                    ? ((h = Q(b)),
                                      b.m(),
                                      L("handleUnauthorizedUser", a, h, d, firebase.auth.EmailAuthProvider.PROVIDER_ID))
                                    : b.a(h)
                                 break
                              default:
      ...
      function dn(a, b, c, d, e, f, g, h, k) {
         P.call(this, fl, { phoneNumber: e }, k, "phoneSignInFinish", {
            F: g,
            D: h,
         })
         this.jb = f
      ...
      var gn =
         ...
         !(
            y("Safari") &&
            !(Xb() || y("Coast") || y("Opera") || y("Edge") || y("Firefox") || y("FxiOS") || y("Silk") || y("Android"))
         )
      function hn(a, b) {
      ...
      function qn(a, b, c) {
         ...
         d &&
            (c &&
               ((c = Ua(Wi(ln.call(this)) || "")),
               (b = Ph(b, c)),
               b.length && b[0].b != d.b && ((c = "+" + d.b + c.substr(b[0].b.length + 1)), Xi(ln.call(this), c))),
            (b = Qh(this.Ba)),
            (this.Ba = a),
         ...
         U: function (a) {
            ...
            if (d.length && !Ma(c, d[0]))
               throw (
                  (Xi(ln.call(this)),
                  ln.call(this).focus(),
                  Oj(nn.call(this), C("The country code provided is not supported.").toString()),
      ...
      function vn(a, b, c, d) {
         ...
         e
            ? Oi
               ...
               : Pi
               ? Oj(b.u(), C("Solve the reCAPTCHA").toString())
               : !Pi && d && b.i().click()
            : (b.O().focus(), Oj(b.B(), Hd().toString()))
      }
      ...
      function zn(a, b, c, d, e, f, g) {
         P.call(this, wk, { email: c, Va: !!b, ia: !!f }, g, "signIn", {
            F: d,
            D: e,
         })
         this.i = a
      ...
      function An(a, b, c, d, e, f, g) {
         P.call(this, Nk, { kc: a, yb: c, Eb: !!d }, g, "unauthorizedUser", {
            F: e,
            D: f,
         })
         this.l = b
      ...
      l.ib = function (a) {
         ...
         !this.da &&
            Ki(W(this)) &&
            (tg("signInSuccess callback is deprecated. Please use signInSuccessWithAuthResult callback instead."),
            (this.da = !0))
      }
      function W(a) {
         Z(a)
      ...
      l.Zb = function (a, b) {
         ...
         return new Ve(function (d, e) {
            ...
            e.uiChanged = function (I, Ca) {
               null === I && "callback" === Ca
                  ? ((I = Vc("firebaseui-id-page-callback", c.s)) && Nj(I), (c.h = new Tn()), c.h.render(c.s))
                  : p ||
                    (null === I && "spinner" === Ca) ||
                    "blank" === Ca ||
