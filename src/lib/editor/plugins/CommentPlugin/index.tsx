...
import type { EditorState, LexicalCommand, LexicalEditor, NodeKey } from "lexical"
...
function CommentInputBox({
   ...
   editor: LexicalEditor
   submitAddComment: (commentOrThread: Comment | Thread, isInlineComment: boolean) => void
}) {
...
export default function CommentPlugin({
   ...
   providerFactory?: (id: string, yjsDocMap: Map<string, any>) => any
}): JSX.Element {
   const collabContext = useCollaborationContext()
   const [editor] = useLexicalComposerContext()
   ...
   const submitAddComment = useCallback(
      (commentOrThread: Comment | Thread, isInlineComment: boolean, thread?: Thread) => {
